...
--
-- Table structure for table `tk_kategori`
--

CREATE TABLE `tk_kategori` (
...
--
-- Indexes for table `tk_kategori`
--
ALTER TABLE `tk_kategori`
...
--
-- AUTO_INCREMENT for table `tk_kategori`
--
ALTER TABLE `tk_kategori`
  MODIFY `subclass_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
