    ...
    <?php echo form_open_multipart('Productdata/Tambahproductheader');?>
      <div class="row">
          ...
          <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
            <div class="holder col-md-4 mb-1">
              ...
              <?php 
                   if ($row->image != null) { ?>
                       <div>
                       <img id="imgPreview" src="<?=site_url('assets/image/'.$row->image)?>" style="width: 300px;" class="img-fluid img-thumbnail"></td>
                       </div>
                   <?php 
                   }
               ?>
        ...
        <div class="form-group col-md-12 <?= form_error('description_header') ? 'has-error' : null ?>">
         ...
         <textarea name="description_header" class="form-control" id="description_header" cols="30" rows="10"><?= $row->description_header?></textarea>
