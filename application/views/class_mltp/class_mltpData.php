<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h3><span class="badge badge-secondary"> Mltp Data</span></h3>
      </div>
      <div class="col-sm-6">
...
<div id="flash" data-flash="<?= $this->session->flashdata('pesan') ?>">
      ...
      <div class="card">
        <div class="card-header" style="background-color:RGB(40, 178, 170);">
          <h3 class="card-title"> Mltp Data</h3>
        ...
        <div class="card-body">
          <div class="card">
            <div class="card-header">
              <a href="<?= site_url('class_mltp/formChose') ?>" class="btn btn-outline-info btn-sm"> <i class="fa fa-plus-square"> Tambah Data</i></a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
