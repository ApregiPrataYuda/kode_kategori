...
<section class="content col-md-12">
  ...
  <div class="card card-secondary">
    ...
    <!-- /.card-header -->
    <div class="card-body">
      <form action="<?= site_url('ClassData/Tambah_ClassData')?>" method="post">
        <div class="row">
          ...
          <div class="col <?= form_error('nama_class') ? '' : null ?>">
            ...
            <input type="text" class="form-control" value="<?= set_value('nama_class') ?>" name="nama_class" id="nama_class" placeholder="Nama Master Class ...">
          ...
          <div class="col-md-2 <?= form_error('kode_class') ? 'has-error' : null ?>">
            ...
            <input type="hidden" class="form-control" value="<?= $kodeClass?>" name="kode_class" id="kode_class" readonly>
        ...
        <div class="row">
          ...
          <label for="nama_class"><span class="badge badge-outline-secondary text-sm">Status*</span> </label>
             ...
             <div class="form-check-inline">
              <input class="form-check-input" type="checkbox" value="Aktif" name="status" id="status">
            ...
            <div class="form-check-inline">
              <input class="form-check-input" type="checkbox" value="NonAktif" name="status" id="status">
              <label class="form-check-label" for="status">
              NonAktif
              </label>
            </div>
